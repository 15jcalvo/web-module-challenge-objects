...
function addReview(array, name, rating, feedback){
  const addedReview = {name: name, rating: rating, feedback: feedback};
  array.push(addedReview);
  console.log(array[8]);
  return array;
}
...
function getReviewByIndex(array, index) {
  const fullReview = array[index].name + " gave the restaurant a " + array[index].rating + " star review, and their feedback was: " + array[index].feedback;
